...
carimg=pygame.image.load('carB.jpg')
...
instruction_background=pygame.image.load("background1.jpg")
car_width=56
pause=False
...
def obstacle(obs_startx,obs_starty,obs):
    if obs==0:
        obs_pic=pygame.image.load("carA.jpg")
    elif obs==1:
        obs_pic=pygame.image.load("carB.jpg")
    elif obs==2:
        obs_pic=pygame.image.load("carC.jpg")
    elif obs==3:
        obs_pic=pygame.image.load("carD.jpg")
    elif obs==4:
        obs_pic=pygame.image.load("carE.jpg")
    elif obs==5:
        obs_pic=pygame.image.load("carF.jpg")
    elif obs==6:
        obs_pic=pygame.image.load("carG.jpg")
